...
public class MedicoController {
    ...
    @GetMapping
    public ResponseEntity<Page<DatosListadoMedico>> listadoMedicos(@PageableDefault(size = 10)
                                                                       Pageable paginacion) {
        return ResponseEntity.ok(medicoRepository.findByActivoTrue(paginacion).map(DatosListadoMedico::new));
    }

    @GetMapping("/inactivos")
    public ResponseEntity<Page<DatosListadoMedico>> listadoMedicosInactivos(@PageableDefault(size = 10)
                                                                   Pageable paginacion) {
