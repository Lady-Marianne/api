...
class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Debería devolver null cuando el médico buscado está activo pero no " +
            "está disponible en esa fecha y horario.")
    void elegirMedicoAleatorioDisponibleEnLaFechaEscenario1() {
        ...
        var medico = registrarMedico("Medico1", "medico@gmail.com",
                "12345", Especialidad.CARDIOLOGIA);
        var paciente = registrarPaciente("Paciente1",
                "paciente@gmail.com", "123789");
